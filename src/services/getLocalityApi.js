...
export const callGetLocalityApi = async (pinCode) => {
        ...
        const {data = {}} = await axiosInstance.get(URL.GET_LOCALITY(pinCode) + jwt ); //if we dont recive any respons then it give rspons like this data = {}
