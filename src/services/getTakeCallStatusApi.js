...
export const callGetTakeCallStatusApi = async () => {
        ...
        const {data = {}} = await axiosInstance.get(URL.GET_TAKE_CALL_STATUS_API + jwt ); //if we dont recive any respons then it give rspons like this data = {}
