...
export const callAddCustomRateApi = async (payload) => {
    // console.log(payload ,'Url payload ----')
        ...
        const {data = {}} = await axiosInstance.post(URL.ADD_CUSTOM_RATE_API + jwt , payload ); //if we dont recive any respons then it give rspons like this data = {}
