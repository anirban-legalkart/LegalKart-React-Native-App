...
export const callChangeCallReceiveAvailabilityApi = async (payload) => {
        ...
        const {data = {}} = await axiosInstance.post(URL.CHANGE_CALL_RECEIVE_AVAILABILITY_API + jwt , payload ); //if we dont recive any respons then it give rspons like this data = {}
