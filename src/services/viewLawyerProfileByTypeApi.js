...
export const callViewLawyerProfileByTypeApi = async (payload) => {
    // console.log(payload ,'Url payload ----')
        ...
        const {data = {}} = await axiosInstance.post(URL.VIEW_LAWYER_PROFILE_BY_TYPE_API + jwt , payload ); //if we dont recive any respons then it give rspons like this data = {}
