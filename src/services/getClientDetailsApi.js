...
export const callGetClientDetailsApi = async (client_id) => {
        ...
        const {data = {}} = await axiosInstance.get(URL.GET_CLIENT_DETAILS_API(client_id) + jwt ); //if we dont recive any respons then it give rspons like this data = {}
