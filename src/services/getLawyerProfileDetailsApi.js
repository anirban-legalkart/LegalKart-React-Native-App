...
export const callgetLawyerProfileDetailsApi = async () => {
        ...
        const {data = {}} = await axiosInstance.get(URL.GET_LAWYER_PROFILE_DETAILS_API + jwt ); //if we dont recive any respons then it give rspons like this data = {}
