...
export const callGeneratePaymentLinkApi = async (payload) => {
    // console.log(payload ,'Url payload ----')
        ...
        const {data = {}} = await axiosInstance.post(URL.GENERATE_PAYMENT_LINK_API + jwt , payload ); //if we dont recive any respons then it give rspons like this data = {}
