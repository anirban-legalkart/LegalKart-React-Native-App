...
export const callGetStateApi = async () => {
        ...
        const {data = {}} = await axiosInstance.get(URL.GET_STATE + jwt ); //if we dont recive any respons then it give rspons like this data = {}
